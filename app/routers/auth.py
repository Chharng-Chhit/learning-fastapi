...
from app.schemas.token_schema import User
...
async def login_for_access_token(form: OAuth2PasswordRequestForm = Depends()) -> Any:
    '''
    ...
    #     user["email"], user["roles"], access_token_expires
    # )
    # refresh_token = create_refresh_token(user["email"], user["roles"])
